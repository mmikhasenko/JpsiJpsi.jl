...
_, fr_1p = get_fit_results(datadir("simulations", "groups_cross_testing", "results_J1_Nev500_Natt5_Nsamples501.jld2"));
let bins=range(380,450,length=100)
    plot(size=(500,350))
...
let bins=range(-70,70,length=50)
